...
IMAGE_PATH = 'Image'  # path to the chess pieces
...
#Images of piece that can promotion to
PIECE_PROMOTION = [knightW, bishopW, rookW, queenW]

#Convert symbol of piece to image
images = {'b': bishopB, 'B': bishopW, 'p': pawnB, 'P': pawnW,
          'n': knightB, 'N': knightW,
          'r': rookB, 'R': rookW, 'k': kingB, 'K': kingW,
          'q': queenB, 'Q': queenW, None: blank}

#Color of board square
dark_color = '#235f53'
light_color = '#CCC'
selected_light_color = '#757373'
selected_dark_color = '#112e28'
selected_light_color_can = '#ff6666'
selected_dark_color_can = '#a52a2a'
# '#F0D9B5' '#B58863' vang`
# '#c51f83' '#eceed4' do
# '#235f53' 'white'  xanh
# '#757373' xam
